...
if __name__ == '__main__':
    ...
    # sens = sentence_split(text)
    # for sen in sens:
    #     print(sen)
    #
    # for seg in sen_generator(text):
    #     print(len(seg), seg, end='\n\n\n')
